...
{% include manual\_episode\_order.html %}
...
{% for lesson\_episode in lesson\_episodes %}
{% if site.episode\_order %}
{% assign episode = site.episodes | where: "slug", lesson\_episode | first %}
{% else %}
{% assign episode = lesson\_episode %}
{% endif %}
